...
$agtPaths = @(
    "$PSScriptRoot\..\..\..\agent-governance-toolkit\agent-governance-python\agent-mesh\examples\06-eu-ai-act-compliance",
    ...
    "$env:USERPROFILE\source\repos\mosiddi-microsoft\agent-governance-toolkit\agent-governance-python\agent-mesh\examples\06-eu-ai-act-compliance",
