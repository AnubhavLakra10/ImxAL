...
$agtPaths = @(
    "$PSScriptRoot\..\..\..\agent-governance-toolkit\examples\maf-integration\01-loan-processing\python",
    "$env:USERPROFILE\source\repos\imran-siddique\agent-governance-toolkit\examples\maf-integration\01-loan-processing\python",
    "$env:USERPROFILE\source\repos\mosiddi-microsoft\agent-governance-toolkit\examples\maf-integration\01-loan-processing\python",
